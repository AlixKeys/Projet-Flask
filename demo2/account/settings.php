...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo2/account/settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 18:16:41 GMT -->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					<?php require_once('../account/first.html')?>
					<!--begin::Toolbar-->
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="d-flex align-items-center py-3 py-md-1">
								...
								<div class="me-4">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62a4db64acd9f">
										<!--begin::Header-->
										<div class="px-7 py-5">
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62a4db64acd9f" data-allow-clear="true">
														<option></option>
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card mb-5 mb-xl-10">
								<div class="card-body pt-9 pb-0">
									<?php require_once('../account/overviewInclude.html')?>
									<!--begin::Navs-->
									<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 " href="overview.php">Aperçu</a>
										</li>
										<!--end::Nav item-->
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="settings.php">Paramètres</a>
										</li>
										<!--end::Nav item-->
										
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 " href="billing.php">Like</a>
										</li>
										<!--end::Nav item-->
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5" href="statements.php">Publication</a>
										</li>
										<!--end::Nav item-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo2/account/settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 18:16:44 GMT -->
</html>